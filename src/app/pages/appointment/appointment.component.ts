...
import { formatApiDate, notPastDateValidator, startOfToday } from '../../core/utils/date.utils';
...
export class AppointmentComponent implements OnInit {
  ...
  submitBooking(): void {
    ...
    const payload = {
      ...
      date: formatApiDate(formValue.date),
  ...
  getFieldError(fieldName: string): string {
    ...
    if (field.errors['invalidDate'] || field.errors['matDatepickerParse']) {
